  ...
  switch (this.textContent) {
    case "Edit Todo":
      ...
      save.addEventListener(
        "click",
        saveForm.update.bind(this, todo, todoElement)
      );
    ...
    case "Move to project":
      ...
      move.addEventListener(
        "click",
        saveForm.moveToProject.bind(this, todo, todoElement, projectForm)
      );
    ...
    case "Reschedule":
      ...
      schedule.addEventListener(
        "click",
        saveForm.reschedule.bind(this, todo, duedateForm)
      );
    ...
    case "Set priority":
      ...
      priority.addEventListener(
        "click",
        saveForm.prioritize.bind(this, todo, priorityForm)
      );
